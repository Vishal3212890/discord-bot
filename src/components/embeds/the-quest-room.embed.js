...
**Submit Quests**
Submit a quest completion proof using the following command in the channel **#submit-quests**  \`/submit-quest [Quest Name]\` (attach an image proof when using this command)`
};
